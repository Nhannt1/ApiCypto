...
import 'package:cryptoapp/cModels/chartmodel.dart';
...
class _SelectCoinState extends State<SelectCoin> {
  ...
  String _formatVolume(double volume) {
    if (volume >= 1000000000) {
      // Nếu volume >= 1 tỷ, sử dụng tỷ (B)
      return (volume / 1000000000).toStringAsFixed(1) +
          'B'; // Giữ 1 chữ số thập phân
    } else if (volume >= 1000000) {
      // Nếu volume >= 1 triệu, sử dụng triệu (M)
      return (volume / 1000000).toStringAsFixed(1) +
          'M'; // Giữ 1 chữ số thập phân
    } else if (volume >= 1000) {
      // Nếu volume >= 1 nghìn, sử dụng nghìn (K)
      return (volume / 1000).toStringAsFixed(1) + 'K'; // Giữ 1 chữ số thập phân
    } else {
      // Nếu volume nhỏ hơn 1000, hiển thị nguyên bản
                              ...
                              : SfCartesianChart(
                                ...
                                series: <CandleSeries>[
                                  CandleSeries<ChartModel, int>(
                                    ...
                                    lowValueMapper:
                                        (ChartModel sales, _) => sales.low,
                                    highValueMapper:
                                        (ChartModel sales, _) => sales.high,
                                    openValueMapper:
                                        (ChartModel sales, _) => sales.open,
                                    closeValueMapper:
                                        (ChartModel sales, _) => sales.close,
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.add, size: myHeight * 0.02),
                                Text(
                                  'Add to portfolio',
